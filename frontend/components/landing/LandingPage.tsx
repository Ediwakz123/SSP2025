      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center max-w-4xl mx-auto mb-24">
          <div
            ...
            className="inline-flex items-center justify-center w-20 h-20 bg-gray-200 rounded-2xl shadow-sm mb-6 cursor-pointer select-none"
          >
        ...
        {/* PORTALS */}
        <div className={`grid gap-10 max-w-4xl mx-auto ${showUser && showAdmin ? 'md:grid-cols-2' : 'md:grid-cols-1 justify-items-center'}`}>

          {/* USER PORTAL */}
          {showUser && (
            <Card className="bg-white border border-gray-200 shadow-sm rounded-xl w-full max-w-md">
