 ...
 */
function getZoneAdvantageMetrics(categoryBusinesses: any[]) {
 ...
 */
function getSpreadMetrics(categoryBusinesses: any[]) {
...
export function OpportunitiesPage() {
    ...
    // Enhanced market analysis per category
    const categoryAnalysis = categories
        .map((category) => {
            const catBusinesses = getBusinessesByCategory(category);
                                                ...
                                                <div className="flex items-center gap-3 flex-1">
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        <div className="flex flex-wrap items-center gap-3 mt-1 text-sm text-muted-foreground">
                                                            ...
                                                            <span>•</span>
                                                            <span>
                                                                Zone advantage: {cat.zoneLevel} (
                                                                {cat.zoneScore}/100)
                                                            </span>
                                                            <span>•</span>
                                                            <span>
                                                                Spread: {cat.spreadLevel} (
                                                                {cat.spreadScore}/100)
                                                            </span>
                                                        </div>
                                                    </div>
